<div class="custom-card aiz-card-box border-light rounded hov-shadow-md mt-1 mb-2 has-transition bg-white">
    ...
    <div class="position-relative">
        <a href="{{ route('product', $product->slug) }}" class="d-block">
            <img
                class="img-fit lazyload mx-auto h-140px h-md-210px product-img"
