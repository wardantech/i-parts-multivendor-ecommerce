...
@section('content')
    ...
    <div class="home-banner-area mb-4 p-0">
                            ...
                            @foreach ($slider_images as $key => $value)
                                <div class="carousel-box">
                                    <a href="{{ json_decode(get_setting('home_slider_links'), true)[$key] }}">
                                        <img
                                            class="d-block mw-100 overflow-hidden"
                ...
                @if (get_setting('top10_categories') != null)
                    <div class="col-lg-12">
                        <div class="d-flex mb-3 align-items-baseline ">
                            <h3 class="h5 fw-700 mb-0 mc-css">
                                <span class="pb-3 d-inline-block">{{ translate('Explore popular brands') }}</span>
                                <a href="{{ route('categories.all') }}" class="ml-auto mr-0 btn btn-sm seeall">{{ translate('See all') }} <i class="las la-arrow-right"></i></a>
                            </h3>
                                    ...
                                    <li class="li">
                                        <a href="{{ route('products.category', $category->slug) }}">
                                                    ...
                                                    <img
                                                        ...
                                                        data-src="{{ uploaded_asset($category->banner) }}"
                                                        alt="{{ $category->getTranslation('name') }}"
                                                        class="img-fluid img lazyload h-150px"
                                                        onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder.jpg') }}';"
                                                    >
