        ...
        <div class="row">
                    ...
                    @auth
                        ...
                        @else
                            ...
                            <li class="list-inline-item mr-3 border-right border-left-0 pr-3 pl-0 dropdown">
                                <a class="dropdown-toggle no-arrow text-reset mt-1" data-toggle="dropdown" href="javascript:void(0);" role="button" aria-haspopup="false" aria-expanded="false">
                                    <span class="">
            ...
            <div class="col-8 text-right d-none d-lg-block">
                <ul class="list-inline mb-0 h-100 d-flex justify-content-end align-items-center">
                    ...
                    <li class="list-inline-item mr-3 border-right border-left-0 pr-3 pl-0">
                        <a href="{{ route('shops.create') }}" class="text-reset d-inline-block  py-2">
                            <i class="las la-store-alt"></i>
                            <span>{{ translate('Be a Seller') }}</span>
                        </a>
                    </li>
                    @endif
                    ...
                    @endif
                    <li class="d-none d-lg-block ml-3 mr-0">
                        <div class="" id="wishlist">
                            @include('frontend.partials.wishlist')
                        </div>
                    </li>
                    <li class="d-none d-lg-block  align-self-stretch ml-3 mr-0" data-hover="dropdown">
...
<header class="@if(get_setting('header_stikcy') == 'on') sticky-top @endif z-1020 bg-white border-bottom shadow-sm">
    <div class="position-relative logo-bar-area z-1">
        <div class="container">
            <div class="d-flex align-items-center second-nav">

                <div class="col-auto col-xl-3 pl-0 pr-3 d-flex align-items-center">
                    <a class="d-block pt-15px pb-20px mr-3 ml-0" href="{{ route('home') }}">
                        @php
                    ...
                    <div class="d-none d-xl-block align-self-stretch category-menu-icon-box ml-auto mr-0 sbc-btn">
                        Shop by <br> category <i class="las la-angle-down"></i>
                    </div>
                        ...
                        <form action="{{ route('search') }}" method="GET" class="stop-propagation">
                            <div class="d-flex position-relative align-items-center">
                                ...
                                <div class="input-group">
                                    <input type="text" class="border-0 border-lg form-control top-search-form-control" id="search" name="keyword" @isset($query)
                                        value="{{ $query }}"
                                    @endisset placeholder="{{translate('Search for anything')}}" autocomplete="off">
        ...
        <div class="hover-category-menu position-absolute w-100 top-100 left-0 right-0  z-3" id="hover-category-menu">
            <div class="container">
    ...
    @php
        $items = menu('frontend-top-menu');
    @endphp
    @if ( get_setting('header_menu_labels') !=  null )
        <div class="bg-white border-top border-gray-200 py-1">
            <div class="container">
                <ul class="list-inline mb-0 pl-0 mobile-hor-swipe text-center">
                    <li class="list-inline-item mr-0 menu-item-home">
                        <a href="{{ url("/") }}" class="font-80rem px-3 py-2 d-inline-block fw-600 hov-opacity-100 text-reset">
                            Home
                        </a>
                    </li>
                    @foreach ($items as $item)
                        @if ($item->childs->isEmpty())
                            <li class="list-inline-item mr-0">
                                <a href="{{ url('category', $item->slug) }}" class="font-80rem px-3 py-2 d-inline-block fw-600 hov-opacity-100 text-reset">
                                    {{ $item->name }}
                                </a>
                            </li>
                        @else
                            <li class="list-inline-item mr-0 dropdown">
                                <a class="font-80rem px-3 py-2 d-inline-block fw-600 hov-opacity-100 text-reset dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    {{ $item->name }}
                                </a>
