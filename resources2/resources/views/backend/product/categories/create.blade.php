        ...
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('categories.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label">Select Menu</label>
                        <div class="col-md-9">
                            <select class="select2 form-control aiz-selectpicker" name="menu_id" data-toggle="select2" data-placeholder="Choose ..." data-live-search="true">
