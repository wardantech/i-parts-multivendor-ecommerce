            ...
            <div class="px-2 py-4 px-md-4 py-md-3 bg-white ">
                <div class="d-flex mb-3 align-items-baseline">
                    <h3 class="h5 fw-700 mb-0 mc-css">
                        <span class="d-inline-block">{{ translate('Featured Products') }}</span>
                        <a href="/search" class="ml-auto mr-0 btn btn-sm seeall">{{ translate('See All') }} <i class="las la-arrow-right"></i></a>
                    </h3>
                </div>
