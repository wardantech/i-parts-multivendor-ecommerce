...
<section class="bd-lw py-5 text-dark footer-widget b-top-1px">
    <div class="container">
        <div class="row">
                    ...
                    <div class="d-inline-block d-md-block mb-4">
                        <form class="form-inline" method="POST" action="{{ route('subscribers.store') }}">
                            ...
                            <div class="form-group mb-0">
                                <input type="email" class="form-control brs-0" placeholder="{{ translate('Your Email Address') }}" name="email" required>
                            </div>
                            <button type="submit" class="btn btn-primary brs-0">
                                {{ translate('Subscribe') }}
                            </button>
                        </form>
                    </div>
            ...
            <div class="col-lg-3 ml-xl-auto col-md-4 mr-0">
                <div class="text-center text-md-left mt-4">
                    <h4 class="fs-16 text-uppercase fw-600 pb-2 mb-4">
            ...
            <div class="col-lg-2 col-md-4">
                <div class="text-center text-md-left mt-4">
                    <h4 class="fs-14 text-uppercase fw-600 pb-2 mb-4">
...
<!-- FOOTER -->
<footer class="pt-3 pb-7 pb-xl-3 bg-white text-light f-text-center">
    <div class="container">
