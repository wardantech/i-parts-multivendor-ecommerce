...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6">{{translate('Green Web Credential')}}</h5>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('update_credentials') }}" method="POST">
                        <input type="hidden" name="otp_method" value="greenweb">
                        @csrf
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="GREENWEB_URL">
                            <div class="col-lg-3">
                                <label class="col-from-label">{{translate('GREENWEB_URL')}}</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="GREENWEB_URL" value="{{  env('GREENWEB_URL') }}" placeholder="GREENWEB_URL" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="GREENWEB_TOKEN">
                            <div class="col-lg-3">
                                <label class="col-from-label">{{translate('GREENWEB_TOKEN')}}</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="GREENWEB_TOKEN" value="{{  env('GREENWEB_TOKEN') }}" placeholder="GREENWEB_TOKEN" required>
                            </div>
                        </div>
                        <div class="form-group mb-0 text-right">
                            <button type="submit" class="btn btn-sm btn-primary">{{translate('Save')}}</button>
